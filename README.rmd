...
Further, MVO is part of the subjective optimization model suite - i.e. where a required return level is provided. Another common example includes portfolio utility optimization, where an explicit risk preference (typically called λ
) is provided and incorporated into the optimization as:
...
Port (Balanced)
have restrictions-> wights risk prefenrences
plug into optimizer 
